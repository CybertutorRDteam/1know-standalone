...
function PDFViewerPlugin() {
    ...
    function init(callback) {
        ...
        loadScript('/library/ViewerJS/compatibility.js', function () {
            loadScript('/library/ViewerJS/pdf.js');
            loadScript('/library/ViewerJS/pdf_find_bar.js');
            loadScript('/library/ViewerJS/pdf_find_controller.js');
            loadScript('/library/ViewerJS/ui_utils.js');
            loadScript('/library/ViewerJS/text_layer_builder.js');
            loadScript('/library/ViewerJS/pdfjsversion.js', callback);
        });

        pluginCSS = document.createElement('link');
        pluginCSS.setAttribute("rel", "stylesheet");
        pluginCSS.setAttribute("type", "text/css");
        pluginCSS.setAttribute("href", "/library/ViewerJS/PDFViewerPlugin.css");
    ...
    this.initialize = function (viewContainer, location) {
        ...
        init(function () {
            PDFJS.workerSrc = "/library/ViewerJS/pdf.worker.js";
