    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.addShapes = function(items) {
            ...
            items.forEach(function(stroke) {
                if (stroke.type === undefined || stroke.type === 'LinePathShape') {
        ...
        // 加入的功能
        LiterallyCanvas.prototype.playStrokes = function(speed) {
            var lc = this;
...
(function() {
    ...
    initLiterallyCanvas = function(el, opts) {
        ...
        opts = _.extend({
            ...
            toolClasses: [ LC.PencilWidget, LC.LineWidget, LC.CircleWidget, LC.OvalWidget, LC.RectangleWidget, LC.PanWidget, LC.EyeDropperWidget, LC.EraserWidget ]
        }, opts);
        $el = $(el);
        $el.addClass("literally");
        $tbEl = $('<div id="literally-toolbar" class="toolbar">');
        $el.append($tbEl);
        $c = $el.find("canvas");
...
(function() {
    ...
    LC.toolbarHTML = '<div class="toolbar-row">\
                        <div class="toolbar-row-left" style="margin-left:4px">\
                            <div class="tools btn-group"></div>\
                            <div style="margin:0 4px 0 16px;display:inline-block;vertical-align:top" translate="LL01"></div>\
                            <div class="color-square background-picker"></div>\
                            <div style="margin:0 4px 0 16px;display:inline-block;vertical-align:top" translate="LL02"></div>\
                            <div class="color-square primary-picker"></div>\
                            <div class="color-square secondary-picker"></div>\
                        </div>\
                        <div class="toolbar-row-right" style="margin-right:4px">\
                            <div>\
                                <div class="btn btn-xs btn-danger clear-button"><span translate="LL03"></span></div>\
                                <div class="btn-group">\
                                    <div class="btn btn-xs btn-default undo-button"><i class="fa fa-fw fa-undo"></i></div>\
                                    <div class="btn btn-xs btn-default redo-button"><i class="fa fa-fw fa-repeat"></i></div>\
                                </div>\
                                <div class="btn-group">\
                                    <div class="btn btn-xs btn-default zoom-out-button"><i class="fa fa-fw fa-minus"></i></div>\
                                    <div class="btn btn-xs btn-default zoom-in-button"><i class="fa fa-fw fa-plus"></i></div>\
                                </div>\
                                <div class="label label-primary zoom-level">1</div>\
                            </div>\
                        </div>\
    ...
    LC.Toolbar = function() {
        ...
        Toolbar.prototype.initTools = function() {
            ...
            return _.each(this.tools, function(t) {
                ...
                buttonEl = $("        <div class='btn btn-xs btn-default tool-" + t.cssSuffix + "'>          <div class='tool-image-wrapper'></div>        </div>        ");
        ...
        Toolbar.prototype.selectTool = function(t) {
            this.$el.find(".tools .btn-primary").removeClass("btn-primary");
            this.$el.find(".tools .tool-" + t.cssSuffix).addClass("btn-primary");
            t.select(this.lc);
...
(function() {
    ...
    LC.StrokeWidget = function(_super) {
        ...
        StrokeWidget.prototype.options = function() {
            ...
            $el = $("      <span class='brush-width-min'>1 px</span>      <input style='width:120px;display:inline-block' type='range' min='1' max='50' step='1' value='" + this.tool.strokeWidth + "'>      <span class='brush-width-max'>50 px</span>      <span class='brush-width-val'>(5 px)</span>    ");
    ...
    LC.OvalWidget = function(_super) {
        ...
        OvalWidget.prototype.button = function() {
            // return "<img src='" + this.opts.imageURLPrefix + "/oval.png'>";
    ...
    LC.EyeDropperWidget = function(_super) {
        ...
        EyeDropperWidget.prototype.button = function() {
            ...
            return "<i class='fa fa-fw fa-filter'></i>";
        };
