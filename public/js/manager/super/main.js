...
.config(function($routeProvider, $locationProvider, $sceProvider, $translateProvider) {
    $routeProvider
    // .when('/dashboard', {
    //   templateUrl: ['/template/manager/super/dashboard.html?', Date.now()].join(''),
    //   controller: 'DashboardCtrl',
    //   controllerAs: 'dashboardCtrl'
    // })
    .when('/accounts', {
      templateUrl: ['/template/manager/super/accounts.html?', Date.now()].join(''),
      controller: 'AccountsCtrl',
      controllerAs: 'accountsCtrl'
    })
    .when('/permission', {
      templateUrl: ['/template/manager/super/permission.html?', Date.now()].join(''),
      controller: 'PermissionCtrl',
      controllerAs: 'permissionCtrl'
    })
    .when('/config', {
      templateUrl: ['/template/manager/super/config.html?', Date.now()].join(''),
...
.directive('main', function() {
    return {
        templateUrl: ['/template/manager/super/main.html?', Date.now()].join(''),
        controller: 'MainCtrl',
