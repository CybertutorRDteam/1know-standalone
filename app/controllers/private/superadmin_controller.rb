class Private::SuperadminController  < ApplicationController
	...
	def set_sys_config
		...
		content.each do |key, value|
			...
			when 'qiniu_activate'
				APP_CONFIG['qiniu']['activate'] = (value.to_s == 'true')
			when 'qiniu_access_key'
				APP_CONFIG['qiniu']['access_key'] = value
			when 'qiniu_secret_key'
				APP_CONFIG['qiniu']['secret_key'] = value
			when 'qiniu_domain'
				APP_CONFIG['qiniu']['domain'] = value
			when 'qiniu_bucket_access_key'
				APP_CONFIG['qiniu']['bucket_access_key'] = value
			when 'qiniu_bucket_secret_key'
				APP_CONFIG['qiniu']['bucket_secret_key'] = value
